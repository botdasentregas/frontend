...
const BlankPage = () => {
  ...
  const handleRefreshWithdrawals = async () => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch("https://alive-kind-jennet.ngrok-free.app/api/withdrawal/admin/withdrawals", {
        headers: {
          "x-api-key": apiKey,
        },
      });
  ...
  const handleApproveWithdrawal = async (withdrawalId) => {
    ...
    setIsLoading(true);
    try {
      const response = await fetch(`https://alive-kind-jennet.ngrok-free.app/api/withdrawal/admin/withdrawal/${withdrawalId}`, {
        method: "PUT",
        headers: {
          "x-api-key": apiKey,
